...
extern void zengl_selectCanvas(int id);
...
PyObject * select_canvas(PyObject * self, PyObject * args, PyObject * kwargs) {
...
static PyMethodDef module_methods[] = {
    {"select_canvas", (PyCFunction)select_canvas, METH_VARARGS | METH_KEYWORDS, NULL},
    {NULL},
};
